...
func (e *Event) Save() error {
	// create sql query for inserting event into the db
	query := `
	...
	// assign newly created ID in database to event
	e.ID = id
...
func GetAllEvents() ([]Event, error) {
	...
	// create sql query for fetching events from the db
	query := `
	SELECT * FROM events
	`
